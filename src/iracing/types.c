...
typedef enum {
    IRACING_STATUS_OK = 0,
    IRACING_STATUS_CLIENT_NOT_INITIALIZED = -1,
    IRACING_STATUS_HEADER_NOT_INITIALIZED = -2,
    IRACING_STATUS_INFO_NOT_INITIALIZED = -3,
    IRACING_STATUS_ALLOCATION_FAILED = -10,
    IRACING_STATUS_OUT_OF_INDEX = -20,
} iracing_status_t;
